...
public class HangmanFrame extends JFrame implements ActionListener, WindowListener{
	...
	public void guessWholeWord() {
		...
		String guess = (String) JOptionPane.showInputDialog(this, dialog, title, 
				JOptionPane.PLAIN_MESSAGE);
		if(guess != null) {
